...
$query=$conn->prepare("INSERT INTO cafe VALUES('','americano','freshly ground ','1.50','drinks','yes')");
$query->execute();

$query=$conn->prepare("INSERT INTO cafe VALUES('','cappuccino','with fully fat or skimmed milk','2.00','drinks','yes')");
$query->execute();

$query=$conn->prepare("INSERT INTO cafe VALUES('','lasagne','with chips or garlic bread','6.50','main','yes')");
$query->execute();

$query=$conn->prepare("INSERT INTO cafe VALUES('','baked potato','with cheese, coleslaw, beans or tuna','4.50','main','yes')");
$query->execute();
